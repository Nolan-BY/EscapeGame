...
-- Listage de la structure de la base pour sae310
CREATE DATABASE IF NOT EXISTS `sae310` /*!40100 DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci */;
USE `sae310`;

-- Listage de la structure de la table sae310. gamecontrol
...
-- Listage des données de la table sae310.users : ~2 rows (environ)
